...
function Input({ onChange, onBlur, label, placeholder, errormessage, autofocus, value, type, objectKey }) {
  ...
  return (
    <div className="form-field form-field-invalid">
        <input id="field-text" type={type} required={true} value={value} onChange={handleOnChange} onBlur={handleOnChanges} autoFocus={autofocus} placeholder={placeholder}></input>
